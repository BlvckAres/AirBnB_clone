<p align="center">
<img src="https://github.com/BlvckAres/AirBnB_clone/blob/main/assets/AirBnB_logo.png?raw=true" alt="HolbertonBnB logo">
</p>
...
The interface that we have created is specifically designed and created to work for the clone AirBnB. The command-line interpreter
will serve as the bridge for users to engage with backend. The "console" was developed with python and it can
...
## Authors :black_nib:
* **Xolani Z Chauke <[BlvckAres](http://github.com/BlvckAres)>
