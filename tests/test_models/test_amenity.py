#!/usr/bin/python3
""" This is a unittest module for the Amenity Class.
...
class TestAmenity_instantiation(unittest.TestCase):
    ...
    def test_two_amenity_unique_ids(self):
        amy1 = Amenity()
        amy2 = Amenity()
        self.asserNotEqual(amy1.id, amy2.id)
    ...
    def test_str_representation (self):
        ...
        amy = Amenity()
        amy.id = "123456"
        amy.created_at = amy.updated_at = dtm
        amystr = amy.__str__()
        self.assertIn("[Amenity] (123456)", amystr)
        self.assertIn("'id': '123456'", amystr)
        self.assertIn("'created_at': " + dtm_repr, amystr)
        self.assertIn("'updated_at': " + dtm_repr, amystr)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        dt = datetime.today()
        dt_iso = dt.isoformat()
        amy = Amenity(id="345", created_at=dt_iso, updated_at=dt_iso)
        self.assertEqual(amy.id, "345")
        self.assertEqual(amy.created_at, dt)
        self.assertEqual(amy.updated_at, dt)
...
class TestAmenity_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        amy = Amenity()
        amy.middle_name = "Holberton"
        amy.my_number = 98
        self.assertEqual("Holberton", amy.middle_name)
